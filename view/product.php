...
$.ajax({
      url:"http://localhost:3000/product/"+id+",
        ...
        success: function (result) {
          ...
          console.log(obj.id);
              $("#product-all").append(" <div class='col-sm-4'>"
	   +"<div class='panel panel-primary'>"
       +" <div class='panel-heading'>"+obj.name+"</div>"
       +" <div class='panel-body'><img src='/images/"+obj.image+"' class='img-responsive' style='width:100%' alt='Image'></div>"
       +"<div class='panel-footer'>"+obj.description+"</div></div>"
	   +"        <div class='separator clear-left'>"
       +"<p class='btn-details'>"
       +" <i class='fa fa-shopping-cart'></i><a href='"+"http://localhost:3001/product/?id="+obj.id+"' class='hidden-sm'>More details</a></p>"
